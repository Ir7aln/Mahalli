  ...
  () =>
    [
      ...
      sellingPriceMin.value
        ? {
            key: "selling_price_min",
            label: `${t("fields.selling-price")} ${t("filters.min")}`,
            value: sellingPriceMin.value,
          }
        : null,
      sellingPriceMax.value
        ? {
            key: "selling_price_max",
            label: `${t("fields.selling-price")} ${t("filters.max")}`,
            value: sellingPriceMax.value,
          }
        : null,
