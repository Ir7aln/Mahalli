  ...
  <Card class="card-modal-shell max-w-xl">
    <div class="card-modal-header">
      <div class="card-modal-header-inner">
        <div class="space-y-1">
          <p class="card-modal-eyebrow">{{ t("routes.quotes") }}</p>
          <h2 class="card-modal-title">{{ t("titles.quotes.delete") }}</h2>
          <p class="card-modal-description">{{ t("modalDescriptions.quotes.delete") }}</p>
        </div>
    ...
    <CardContent class="card-modal-body">
      <div class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
        <p class="text-sm text-slate-500">{{ t("fields.quote") }}</p>
